clear
use "`RAW_HEALTH4'/b3b_cd3.dta"

keep hhid07 pid* cd05 cdtype

drop if cd05==9 | cd05==.

reshape wide cd05, i (hhid07 pid07 pidlink) j (cdtype) string
...
drop cd05*
save "`WORKING_HEALTH'/chronic07.dta", replace
